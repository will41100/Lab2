...
# Functions needed to implement in this file:

# 1. compute_s_box() --> returns binary value for the 4-bit output of the S-box based on the 6-bit input block
# This function returns a string, for example the input '101010' --> output of '1100'
# Use binvalue() from des.py

# 2. Implement substitute() function
# Accepts d_e, which is a string of 48 bits and returns another list which is substituted using the S_BOX
